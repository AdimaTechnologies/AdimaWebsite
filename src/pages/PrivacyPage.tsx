    ...
    <main className="min-h-screen bg-[#0B0C10] pt-32 pb-20 px-6">
      <div className="container mx-auto max-w-3xl">
        ...
        <div className="prose prose-invert max-w-none text-[#A6A9B1] space-y-6">
          ...
          <p>We use your information to respond to enquiries, process applications, and improve our services.</p>
          <h2 className="text-[#F7F8FB] text-xl font-semibold mt-8">3. Data Security</h2>
          <p>We implement appropriate measures to protect your personal data.</p>
          <h2 className="text-[#F7F8FB] text-xl font-semibold mt-8">4. Contact</h2>
          <p>For privacy-related questions, contact <a href="mailto:info@adimatechnologies.com" className="text-[#2D6BFF] hover:underline">info@adimatechnologies.com</a>.</p>
        </div>
      </div>
    </main>
  );
